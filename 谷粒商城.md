...
![](\picture\QQ拼音截图20201106235929.png)
...
![](\picture\QQ拼音截图20201107011440.png)

当然你要先知道本地主机的VirtualBox网桥的网段：

![](\picture\QQ拼音截图20201107011700.png)

实际就是做一个网络适配，使得电脑和虚拟机在同一个网段之下。

![image-20210605202337644](\picture\image-20210605202337644.png)
...
![](\picture\QQ拼音截图20201107020817.png)
...
![](\picture\QQ拼音截图20201107031553.png)
...
![](\picture\QQ拼音截图20201107023809.png)

Navicat连接测试（关于软件的破解建议打开微信的文章进行搜索）

![](\picture\QQ拼音截图20201107024948.png)
...
![](\picture\QQ拼音截图20201109053408.png)
...
![](\picture\QQ拼音截图20201109055943.png)

执行该sql脚本：

![](\picture\QQ拼音截图20201109060132.png)

2、修改配置，数据库帐号密码为你本地帐号密码

![](\picture\QQ拼音截图20201109060430.png)

3、修改bin目录下的启动脚本改成单例

![](\picture\QQ拼音截图20201109060624.png)
...
![](\picture\QQ拼音截图20201111112336.png)
